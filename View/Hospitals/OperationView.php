...
class OperationView
{
    ...
    public function showServices($myResult, $HospitalID, $customerID, $customerName) 
    {
		$odd = true;
		...
		echo '<td width="150"><div align="center">
				<a href="newOperation.php?cid=' .$customerID. '&cName=' .$customerName. '&did=' .$HospitalID.'">أضف سجلاً جديداً</a>
				 </div></td>';
		echo '</tr>';
		echo '</table>';
	}

    public function showCustomerInfo($row, $HospitalID, $customerID, $customerName) 
    {
		$odd = true;
		echo '<div align="center">
