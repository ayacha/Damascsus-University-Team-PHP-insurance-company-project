                                  ...
                                  <tr>
                                        <td align="center">
                                        	<div id="css_horizontal_menuC">
                                                <a href="CustomerTreatments.php?ID=<?php echo $ID;?>" class="first">المعالجات</a>
                                                <a href="CustomerMedications.php?ID=<?php echo $ID;?>">المداواة</a>
                                    ...
                                    <tr>
                                    	<td align="center" height="150" valign="top">
                                        	<?php
													$viewCustomer->showCustomerTreatments($ID);
												 ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                    	<td align="left">
                                        	<?php
												echo '<form method="post" action="'. $viewCustomer->CustomerTreatmentsPDF($ID) .'">';
													echo '<td  width="150"><input name="pdf1" type="submit" value="تحميل" /></td>';
												echo '</form>';
												 ?>
                                        </td>
                                    </tr>
