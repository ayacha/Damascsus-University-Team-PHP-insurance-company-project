                                  ...
                                  <tr>
                                        <td align="center">
                                        	<div id="css_horizontal_menuC">
                                                ...
                                                <a href="CustomerOperations.php?ID=<?php echo $ID;?>" class="first">العمليات</a>
                                            </div> 
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                    	<td align="center" height="150" valign="top">
                                        	<?php
													$viewCustomer->showCustomerOperations($ID);
												 ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                    	<td align="left">
                                        	<?php
												echo '<form method="post" action="'. $viewCustomer->CustomerOperationsPDF($ID) .'">';
													echo '<td  width="150"><input name="pdf3" type="submit" value="تحميل" /></td>';
												echo '</form>';
												 ?>
                                        </td>
                                    </tr>
