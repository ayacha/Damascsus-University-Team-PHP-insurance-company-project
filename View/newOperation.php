...
<body>
    	<form name="newOperation" method="post" action="" dir="rtl">
                    	  ...
                    	  <td style="width:50%;" valign="top">
                          	<table>
                            	<tr style="width:100%;">
                                            ...
                                            <table  width="100%" dir="rtl">
                                                <tr>
                                                  ...
                                                  <td style="width:50%;">
                                                        ...
                                                        echo '<form method="post" action="'. $opr->addOperation() .'">';
                                                        ?>
                                    ...
                                    <input name="addOperation" type="submit" value="إضافة" />
                                                            <?php echo '</form'; ?>
